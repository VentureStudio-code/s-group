  ...
  return (
    ...
    >
      ...
      <Typography variant="body1" paragraph>
        Welcome to the S-Group Network (Pty) Ltd website and services. By accessing or using our website, you acknowledge that you have read, understood, and agree to comply with the terms outlined in this disclaimer.
      </Typography>
      ...
      <List>
        ...
        <ListItem>
          <ListItemText
            primary="Investment Channels"
            secondary="Within the S-Group community, investment channels such as S-Vest 2.0 and S-Vest SA provide a platform for members to exchange trading and investment ideas. While curated content and insights from professionals like Forbes-featured Dorian Prosdocimi are available, members must conduct their own research and due diligence before making any investment decisions."
          />
        </ListItem>
      ...
      <Typography variant="body1" paragraph>
        By using S-Group Network (Pty) Ltd, you agree to the terms outlined in this disclaimer. For questions or concerns, contact us at info@s-group.co.za. Thank you for your understanding and cooperation.
      </Typography>
