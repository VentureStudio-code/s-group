...
function PrivacyPolicy() {
  return (
    <Grid2 sx={{ p: { xs: 2, sm: 3, md: 4, lg: 5 } }}>
      <Grid2 sx={{ p: { xs: 2, sm: 3, md: 4, lg: 5 } }}>
        <Typography fontSize={"2.2rem"}>Privacy Policy</Typography>

        <h1>S-Group Holdings Privacy Policy</h1>
        <p>
          This Privacy Policy describes how your personal information is
          collected, used, and shared when you visit or make a purchase from
          https://smutby.com (the “Site”).
        </p>
        <h2>
        ...
        <p>
          ...
          by e-mail at info@sgroupholdings.co.za
        </p>
      </Grid2>
    </Grid2>
  );
